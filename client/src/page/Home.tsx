...
const INSTAGRAM_REDIRECT_URI =
  "https://api.instagram.com/oauth/authorize?client_id=1005258271215864&redirect_uri=https://yogi-poke-api.is-not-a.store/auth/instagram&scope=user_profile&response_type=code";
